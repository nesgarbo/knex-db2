...
describe('Delete', () =>
{
    ...
    {
        const query = knex.delete().from('test')
            .where('x', 'y');
    ...
    it('supports delete with whereNotExists', () =>
    {
        ...
        testSql(query, 'delete from "test" where not exists (select * from "othertable" where "othertable"."id" = "test"."id")');
    });
    ...
    it('supports delete with orWhereExists', () =>
    {
        ...
        testSql(query, 'delete from "test" where "x" = \'y\' or exists (select * from "othertable" where "othertable"."id" = "test"."id")');
    });
    ...
    it('supports delete with orWhereNotExists', () =>
    {
        ...
        testSql(query, 'delete from "test" where "x" = \'y\' or not exists (select * from "othertable" where "othertable"."id" = "test"."id")');
    });
